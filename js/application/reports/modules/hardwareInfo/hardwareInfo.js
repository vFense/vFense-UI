            ...
            Main: Backbone.View.extend({
                ...
                getSoftwareOverview: function (data) {
                    ...
                    $dl.append(
                        ...
                        crel('dt', 'Environment:'),
                        crel('dd', data.environment ? data.environment + ' ' : 'N/A',
                            crel('button', {class: 'btn btn-link noPadding', 'data-id': 'editModal', 'data-argument': 'environment', 'data-value': data.environment || ''},
                                crel('i', {class: 'icon-pencil', style: 'color: #daa520', title: 'Edit Environment'}))),
